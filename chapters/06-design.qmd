...
We pulled her accountability list. Not her job description — those are always cleaner than the reality. Her actual accountability chart: the items she owned, the work she touched every week. Then we ran every item through the Work Deconstruction classification, task by task. Every item got a classification. Does this require judgment — the kind that depends on knowing the client, knowing the history, reading a room? Does it benefit from agent assistance, with a human reviewing every output? Or is it fully automatable — high-volume, well-defined, clean inputs, predictable outputs?
