...
{{< excalidraw ch08-deploy-readiness-audit "The Deploy Readiness Audit: four binary gates — training, escalation path, real-data test, and the Human Orchestrator's review cadence on the calendar. Anything short of 4/4 stops the deploy." >}}
...
{{< excalidraw ch08-operational-log "The operational log: four columns, one row per gap — the date, what happened, its category, and what it signals for the next Sprint." >}}
...
{{< excalidraw ch08-sprint-outcome-measurement "Meridian's Sprint outcome measurement: the five fields filled in against the $558K constraint Signal named." >}}
