...
<!-- TODO: Excalidraw agent — the coordinator before/after diagram currently uses a triplet pattern. Redesign to avoid the three-item rhetorical structure. -->
...
Task count: Human judgment required — 2. Agent-assisted — 2. Fully automatable — 2. Workflow automation only — 2. The role that felt like "engineering work" was half engineering judgment and half data retrieval, document assembly, and routing that a well-designed agent team could handle.
