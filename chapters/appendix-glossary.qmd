...
**Compound Bench**
: Six AI coaching agents — one per stage of the Sequence — that run the framework *with* you during a sprint: interrogating constraints, surfacing knowledge gaps, running Work Deconstruction, specifying builds, structuring rollouts, and closing the retrospective. Available through Compound membership. (First introduced: Chapter 3)
...
**Skills Library**
: Twelve pre-built, installable workflow instruments — two per stage of the Sequence — that stay inside a company's systems after a sprint ends and make each subsequent sprint faster. Where the Bench coaches you through the method, the Library is your toolkit for the output. Available through Compound membership. (First introduced: Chapter 3)
