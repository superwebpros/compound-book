...
{{< excalidraw appendix-context-stack "The context engineering stack: five layers from prompt to tool connections, with Compound Sprint artifacts mapped to each layer." >}}
