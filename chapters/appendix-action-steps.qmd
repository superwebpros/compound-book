...
:::{.callout-note}
## Action Step
Before the Sprint enters Build, put the Compound session on the calendar. A 90-minute block with the Human Orchestrator and everyone who owned a Sprint accountability. If it's not scheduled before the Sprint ships, it won't happen after.
:::
