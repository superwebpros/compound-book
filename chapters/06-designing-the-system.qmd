...
The four questions are not a template to fill in once and forget. They are a design discipline. Every sprint adds one row to the Hybrid Accountability Chart, and every row forces the four answers — including the harder ones. "Who supervises this team?" is uncomfortable when the agent team is producing work nobody on the leadership team has owned before. That discomfort is the point. The chart surfaces it before any code is written.
...
Beneath the Human Orchestrator sits an operational role: the *Agent Coordinator*. This is a human role — a person, not an agent.
