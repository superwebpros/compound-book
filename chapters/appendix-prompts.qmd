...
Work Deconstruction classifies every task in the constraint workflow into the three categories of the TML framework — Task, Management, Leadership. It also documents source inputs and outputs for each task. This is the method that reveals the actual shape of a role. See Chapter 6b.
