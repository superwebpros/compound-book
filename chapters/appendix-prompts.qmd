...
- If more than half landed in Leadership, push back on each one: is
  this genuinely judgment about people / strategy / context, or is it
  judgment because nobody has written down the rules? Many tasks feel
  like judgment because the rules are undocumented, not because the
  rules don't exist.
