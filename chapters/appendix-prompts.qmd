...
The Hybrid Accountability Chart extends your org's accountability chart to include agent teams alongside humans. Each entry names the function, the agent team, the human supervisor, and the autonomy level. Every row must have a named human supervisor — no exceptions. See Chapter 7.
