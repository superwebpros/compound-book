...
The agents we designed in the last chapter — the ones that replaced 90% of the coordinator's function — this is where they got built. Design told us the shape. Build executed it.
...
I said: go into Claude. Start the skill creator. Copy in your three best posts. Tell it what worked about each one. Ten minutes — by the time the half is over — you've built a skill. You've got a pipeline. You don't need a developer. You don't need us to do it for you.

The reason I'm telling you this is because Build doesn't require an engineer. It requires a design that names the shape. The client's workflow was simple enough that a skill did it. That's not a limitation — that's exactly the point. When Design has done its job, the build path reveals itself.
