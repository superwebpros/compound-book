...
The agents we designed in the last chapter took on the bulk of the workflow the Human Orchestrator used to manage alone. (The Human Orchestrator is the person who runs the agent team for a Sprint: assigns work, reviews outputs, escalates exceptions — not a chatbot, a human coordinator. If you run EOS, this is the closest thing to the Integrator role, extended to the agent team rather than the whole company. More in the Co-Operating Model chapter.) This is where they got built, to the shape Design specified.
