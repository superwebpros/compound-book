...
8. **Environment and constraints.** Which specific environment inside Design's category (off-the-shelf, low-code, hand-built; see the Designing the System chapter) this build runs on, and why. Any constraints the builder must observe: data residency (legal or regulatory requirements that your data stay in a specific geography or on servers you control), existing licenses, internal security requirements.
