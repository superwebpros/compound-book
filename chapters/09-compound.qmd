...
:::{.callout-note}
## Action Step
Before the Sprint enters Build, put the Compound session on the calendar. Include the Human Orchestrator (the person who owns the Sprint design and runs the Compound session — covered in the Design chapter) and every supervisor who owned a Sprint accountability. If it's not scheduled before the Sprint ships, it won't happen after. (If you run EOS, the Human Orchestrator is the Integrator role extended to run the agent team — Sprint-level, not company-level.)
:::
