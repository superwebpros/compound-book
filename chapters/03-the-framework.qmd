...
**Design** splits the work between humans and agents, role by role and handoff by handoff. It produces a **Hybrid Accountability Chart** (if you run EOS, this extends your Accountability Chart by adding agent seats and their Human Orchestrators) and a **Design Brief**. You learn it in the Design chapters.
